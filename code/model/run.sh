...
CUDA_VISIBLE_DEVICES=1,3 accelerate launch --config_file train.yaml train.py
#accelerate launch run.py --dataset conala
#accelerate launch run.py --dataset mathqa
#accelerate launch run.py --dataset django
#accelerate launch run.py --dataset mbpp 
#accelerate launch run.py --dataset concode 
