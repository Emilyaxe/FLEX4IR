...
with open("./mlir_functions_ori.json", 'r') as file:
    data = json.load(file)
...
adddata(f"../exp_script/correct_generated_{index}.json")
adddata(f"../exp_script/new_generated_{index}.json")

with open("./mlir_functions_ori.json", 'w') as file:
